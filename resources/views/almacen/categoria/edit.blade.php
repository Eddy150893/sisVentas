...
@section('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			@endif
{{-- El formlario model sirve para actualizar debe recibir el objeto que se va a actualizar luego dentro de un array recibe
method: verbo http
un array
route: la ruta del controlador al cual se enviaran los datos al igual que el id del objeto a actualizar --}}
